...
namespace ChessGameApi.Handlers
{
    ...
    {
        private static readonly Dictionary<ChessPieceNames, (ChessPiece White, ChessPiece Black)> _pool;
        ...
        private static void FillPool()
        {
            ...
            {
                _pool.Add(val, new(CreatePiece(val, ChessColors.White), CreatePiece(val, ChessColors.Black)));
            }
        }
